                ...
                <ul>
                    ...
                    <li data-index="rs-3" data-transition="slideoververtical">
                        ...
                        <div class="tp-caption Photography-Display tp-resizeme" id="slide-3-layer-2" 
                            ...
                            style="z-index: 6; white-space: nowrap; font-family: Playfair Display;">Javier Enrique Condori Cruz</div>
                        ...
                        <div class="tp-caption Photography-Display tp-resizeme" id="slide-3-layer-3" 
                            ...
                            style="z-index: 7; white-space: nowrap; color: #bc9355; font-family: Playfair Display;">Javier Enrique Condori Cruz
                        </div>
                ...
                <div class="row mb30">
                    <div class="col-md-5 col-sm-5">
                        <div class="footer-contact text-right">
                            <p>Telefono: +591 60642677</p>
                            <p>E-mail: <a href="http://sitetemplate.demo.ithemeslab.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="533a3d353c132a3c2621373c3e323a3d7d303c3e">LLamanos y contractanos</a></p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-social">
                            <ul>
                                <li><a href="https://www.facebook.com" target="_black"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.youtube.com/" target="_black"><i class="fa fa-youtube"></i></a></li>
                                <li><a href="https://www.linkedin.com/" target="_black"><i class="fa fa-linkedin"></i></a></li>
                                <li><a href="https://www.gmail.com/" target="_black"><i class="fa fa-google-plus"></i></a></li>
                                <li><a href="https://www.linkedin.com/" target="_black"><i class="fa fa-pinterest"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
